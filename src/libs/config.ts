...
export const saveServerConfig = (config: typeof DEFAULT_CONFIG) => {
  Object.assign(SERVER_CONFIG, config);
  localStorage.setItem('server_config', JSON.stringify(config));
};

export const SERVER_CONFIG = loadConfig();
...
export const TURNSTILE_SITE_KEY = '0x4AAAAAADLNmi6RQBRHM0zq'
