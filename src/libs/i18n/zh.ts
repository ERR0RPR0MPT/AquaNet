...
const zhHome: typeof EN_REF_HOME = {
  ...
  'home.setup': '连接到 '+SERVER_CONFIG.SERVER_NAME,
  ...
  'home.setup.welcome': "欢迎! 如果您有街机框体或者手台，请按照以下说明设置以连接到 "+SERVER_CONFIG.SERVER_NAME+"。",
  ...
  'home.setup.test': "在您重新启动游戏后，应该能够连接到 "+SERVER_CONFIG.SERVER_NAME+"。可以验证测试菜单中的网络测试测试连接是否全部良好。",
...
export const zhMaiPhoto: typeof EN_REF_MAI_PHOTO = {
  ...
  'maiphoto.url_warning': '注意：如果想与朋友分享图片的话，请先保存照片再发出去。不要复制图片 URL，因为 URL 中包含 '+SERVER_CONFIG.SERVER_NAME+' 账号信息。',
