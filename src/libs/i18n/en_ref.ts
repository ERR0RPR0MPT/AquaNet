...
export const EN_REF_HOME = {
  ...
  'home.setup.welcome': 'Welcome! If you own an arcade cabinet or game setup, please follow the instructions below to set up the connection with ' + SERVER_CONFIG.SERVER_NAME + '.',
  ...
  'home.setup.test': 'Then, after you restart the game, you should be able to connect to ' + SERVER_CONFIG.SERVER_NAME + '. Please verify that the network tests are all GOOD in the test menu.',
...
export const EN_REF = {
  ...EN_REF_USER, ...EN_REF_Welcome, ...EN_REF_GENERAL,
